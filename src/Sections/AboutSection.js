  ...
  if (!aboutData) {
    return (
      <section id="about-section" className="py-24 bg-gradient-to-b from-slate-50 relative overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="text-center">
            <p className="text-slate-600">About section content not available</p>
          </div>
        </div>
      </section>
    )
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-8 animate-slide-up">
              <div className="flex items-center space-x-4 group">
                ...
                <div className="relative">
                  <span className="text-sm font-semibold text-amber-600 tracking-[0.3em] relative z-10">
            ...
            <div className="space-y-8 text-slate-600 leading-relaxed">
              {contentParagraphs && Array.isArray(contentParagraphs) && contentParagraphs.map((item, index) => (
                <p
                  key={index}
                  className={`animate-fade-in hover:text-slate-700 transition-colors duration-300 ${
                    item?.isLarge ? 'text-lg font-light' : ''
                  }`}
