...
//         {/* Fencing-inspired geometric lines */}
...
//             <span className="text-xs font-semibold text-amber-400 tracking-[0.3em] uppercase">Contact</span>
//             <div className="w-12 h-px bg-amber-500/60"></div>
//           </div>
...
//             Ready to discover the art and discipline of fencing? Get in touch with us.
//           </p>
//         </div>
...
//             <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-8 lg:p-10">
//               <div className="mb-8">
//                 <h3 className="text-xl font-semibold text-white mb-2">
//                   Send a Message
//                 </h3>
//                 <p className="text-slate-400">
//                   Questions about our programs or ready to start? We're here to help.
//                 </p>
//               </div>
...
//                       required
//                       className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 text-white placeholder-slate-400"
...
//                       onChange={handleInputChange}
//                       required
//                       className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 text-white appearance-none cursor-pointer"
//                     >
...
//                     required
//                     rows={5}
//                     className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 resize-none text-white placeholder-slate-400"
//                     placeholder="Tell us about your fencing goals or any questions you have..."
//                   ></textarea>
//                 </div>
...
//                   <button
//                     type="submit"
//                     className="w-full md:w-auto px-8 py-3 bg-amber-600 hover:bg-amber-500 text-slate-900 font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-amber-600/20"
//                   >
//                     Send Message
//                   </button>
//                 </div>
...
//                 <p>1234 Championship Drive<br />Austin, TX 78701</p>
...
//                   (555) 123-4567
//                 </a>
//                 <a href="mailto:info@texasfencingacademy.org" className="flex items-center text-slate-300 hover:text-amber-400 transition-colors duration-300">
//                   <div className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-3"></div>
//                   info@texasfencingacademy.org
//                 </a>
//               </div>
//             </div>
...
//                 <div className="w-8 h-8 bg-amber-600/20 rounded-lg flex items-center justify-center">
//                   <svg className="w-4 h-4 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
//                     <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-3.22l-1.88 1.88a.75.75 0 01-1.06 0L7.22 15H5a2 2 0 01-2-2V5zm5.99-.5a.5.5 0 00-.99 0v.875a1.5 1.5 0 009.001 0V4.5a.5.5 0 00-.99 0v.875a.5.5 0 01-.99 0V4.5z" clipRule="evenodd" />
//                   </svg>
//                 </div>
...
//                 {[
//                   { href: "https://www.instagram.com/texasfencingacademy/", icon: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" },
//                   { href: "https://www.facebook.com/texasfencingacademy", icon: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
//                   { href: "https://twitter.com/texasfencing", icon: "M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" }
//                 ].map((social, index) => (
//                   <a
//                     key={index}
//                     href={social.href}
...
//                 />
//                 <div
//                   className="w-6 h-6 flex items-center justify-center hidden"
//                   style={{ display: "none" }}
//                 >
//                   <svg
...
//               {['About', 'Programs', 'Gallery', 'Contact'].map((link, index) => (
//                 <a 
//                   key={index}
